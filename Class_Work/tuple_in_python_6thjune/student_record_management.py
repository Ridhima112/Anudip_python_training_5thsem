...
# ---------------------------------------
# Task 3: Display the last student's details using negative indexing
...
# ---------------------------------------
# Task 5: Display count of all students
print("Total Count :", len(students))
print("----------------------------")

# ---------------------------------------
# Task 6: Check whether a student named "Rahul" exists in the records
count = 0
